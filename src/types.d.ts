export type AvailablePages = '/imageGenerationPage' | '/textGenerationPage' | '/audioGenPage';
...
export type CardMainMethods = {
    ...
    getRunCommands: (dir: string) => string | string[];
...
export type CardData = {
    ...
    type: 'image' | 'audio' | 'text' | 'unknown' | undefined;
...
export type Category = 'env' | 'cl' | 'flag' | undefined;