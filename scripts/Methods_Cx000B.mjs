...
function getArgumentType(name, Arguments) {
    var _a;
    return ((_a = getArgumentByName(name, Arguments)) === null || _a === void 0 ? void 0 : _a.type) || undefined;
}
...
export { Arguments as A, parseStringToArgs as a, commonjsGlobal as c, parseArgsToString as p };
